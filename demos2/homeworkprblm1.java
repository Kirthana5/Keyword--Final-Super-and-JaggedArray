...
/*PROBLEM STATEMENT:
     Develop a Java appliication with Employee class with Emp name,
Emp id,Address,Mail id,Mobile no. as members.Inherit the classes,
Programmer,Assisstant Professor,Associate Professor and Professor 
from employee class.Add BasicPay(BP) as the member of all  the 
inherited classes with 97% of BP as DA,10% of BP as HRA,12% of 
BP as PF,0.1% of BP for staff club fund.Generate pay slips for 
